...
import com.feebe.RingTone.R;
import com.feebe.RingTone.Search;
    ...
    implements TextWatcher
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        mWasGetContentIntent = action != null && action.equals(
   ...
   // TODO: isOurDownload use different color, or even rank on top
    ...
    private boolean isOurDownload() {
      ...
      int dataIndex = c.getColumnIndexOrThrow(MediaStore.Audio.Media.DATA);
      String filename = c.getString(dataIndex);
      return filename.startsWith(com.feebe.RingTone.Const.contentDir);
    }
    */
    private void startRingdroidEditor() {
        ...
        try {
          Log.e("file", filename);
          if (filename.startsWith(com.feebe.RingTone.Const.contentDir)) {
          	String jsonFile = com.feebe.RingTone.Const.jsondir +filename.substring(com.feebe.RingTone.Const.contentDir.length());

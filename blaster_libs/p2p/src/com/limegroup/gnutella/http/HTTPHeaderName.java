...
public class HTTPHeaderName {
	 ...
	 */
    public static final String ALT_LOCATION_STR = "X-Alt";
	public static final HTTPHeaderName ALT_LOCATION = 
		new HTTPHeaderName(ALT_LOCATION_STR);
	 ...
	 */
    public static final String GNUTELLA_CONTENT_URN_STR = "X-Gnutella-Content-URN";
	public static final HTTPHeaderName GNUTELLA_CONTENT_URN =
		new HTTPHeaderName(GNUTELLA_CONTENT_URN_STR);

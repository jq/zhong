...
public class PingReply extends Message implements Serializable, IpPort {
    ...
    public static PingReply create(byte[] guid, byte ttl, Collection hosts) {
        return create(
            ...
            ApplicationSettings.LANGUAGE.equals("") ?
    ...
    public static PingReply create(byte[] guid, byte ttl,
        ...
        String locale = ApplicationSettings.LANGUAGE.equals("") ?
                        ApplicationSettings.DEFAULT_LOCALE :
                        ApplicationSettings.LANGUAGE;
    ...
    public static PingReply 
        ...
        return create(guid, ttl, port, ip, files, kbytes, isUltrapeer,
                      newGGEP(dailyUptime, isGUESSCapable));
    }
    ...
    public static PingReply
        ...
        GGEP ggep = newGGEP(dailyUptime, isGuessCapable);
    ...
    private static GGEP newGGEP(int dailyUptime,

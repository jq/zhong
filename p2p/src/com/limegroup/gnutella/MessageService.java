...
public class MessageService {
    ...
    /**
     * Shows a locale-specific message to the user using the specified key to
     * look up the message in the resource bundles if the boolean
     * indicates to do so.
     * 
     * @param messageKey the key for looking up the message to display in the
     *  resource bundles
     */
    public static void showError(String messageKey, boolean ignore) {
     ...
     *  resource bundles
     */
    public static void showMessage(String messageKey, boolean ignore) {
    ...
    private static final class ShellMessageService implements MessageCallback {
        ...
        public void showError(String messageKey) {
            LOG.info("error key: "+messageKey);
        }

        // Inherit doc domment.        
        public void showError(String messageKey, boolean ignore) {
            LOG.info("error key: "+messageKey);
        }

        // Inherit doc comment.
        public void showError(String messageKey, String message) {
            LOG.info("error key: "+messageKey+" extra message: "+
                message);
        }
        ...
        // Inherit doc comment.
        public void showMessage(String messageKey, boolean ignore) {
            LOG.info("message key: "+messageKey); 
        }

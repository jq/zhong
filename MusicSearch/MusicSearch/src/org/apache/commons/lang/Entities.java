...
class Entities {
    ...
    static final String[][] ISO8859_1_ARRAY = {{"nbsp", "160"}, // non-breaking space
        ...
        {"copy", "169"}, // ｩ - copyright sign
        {"ordf", "170"}, // feminine ordinal indicator
        {"laquo", "171"}, // left-pointing double angle quotation mark = left pointing guillemet
        {"not", "172"}, // not sign
        {"shy", "173"}, // soft hyphen = discretionary hyphen
        {"reg", "174"}, // ｮ - registered trademark sign
        ...
        {"Agrave", "192"}, // ﾀ - uppercase A, grave accent
        {"Aacute", "193"}, // ﾁ - uppercase A, acute accent
        {"Acirc", "194"}, // ﾂ - uppercase A, circumflex accent
        {"Atilde", "195"}, // ﾃ - uppercase A, tilde
        {"Auml", "196"}, // ﾄ - uppercase A, umlaut
        {"Aring", "197"}, // ﾅ - uppercase A, ring
        {"AElig", "198"}, // ﾆ - uppercase AE
        {"Ccedil", "199"}, // ﾇ - uppercase C, cedilla
        {"Egrave", "200"}, // ﾈ - uppercase E, grave accent
        {"Eacute", "201"}, // ﾉ - uppercase E, acute accent
        {"Ecirc", "202"}, // ﾊ - uppercase E, circumflex accent
        {"Euml", "203"}, // ﾋ - uppercase E, umlaut
        {"Igrave", "204"}, // ﾌ - uppercase I, grave accent
        {"Iacute", "205"}, // ﾍ - uppercase I, acute accent
        {"Icirc", "206"}, // ﾎ - uppercase I, circumflex accent
        {"Iuml", "207"}, // ﾏ - uppercase I, umlaut
        {"ETH", "208"}, // ﾐ - uppercase Eth, Icelandic
        {"Ntilde", "209"}, // ﾑ - uppercase N, tilde
        {"Ograve", "210"}, // ﾒ - uppercase O, grave accent
        {"Oacute", "211"}, // ﾓ - uppercase O, acute accent
        {"Ocirc", "212"}, // ﾔ - uppercase O, circumflex accent
        {"Otilde", "213"}, // ﾕ - uppercase O, tilde
        {"Ouml", "214"}, // ﾖ - uppercase O, umlaut
        {"times", "215"}, // multiplication sign
        {"Oslash", "216"}, // ﾘ - uppercase O, slash
        {"Ugrave", "217"}, // ﾙ - uppercase U, grave accent
        {"Uacute", "218"}, // ﾚ - uppercase U, acute accent
        {"Ucirc", "219"}, // ﾛ - uppercase U, circumflex accent
        {"Uuml", "220"}, // ﾜ - uppercase U, umlaut
        {"Yacute", "221"}, // ﾝ - uppercase Y, acute accent
        {"THORN", "222"}, // ﾞ - uppercase THORN, Icelandic
        {"szlig", "223"}, // ﾟ - lowercase sharps, German

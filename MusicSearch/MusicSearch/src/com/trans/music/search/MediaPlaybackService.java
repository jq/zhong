...
public class MediaPlaybackService extends Service {
    ...
    public void onCreate() {
		...
		mPsir = new PhoneStateListener(){
			public void onCallStateChanged(int state, String incomingNumber){
				super.onCallStateChanged(state, incomingNumber); 
				switch(state){
					case TelephonyManager.CALL_STATE_IDLE: 
						 Log.e("MusicSearch DEBUG", "phone is idle"); 
                         if (mResumeAfterCall) {
					...
					case TelephonyManager.CALL_STATE_OFFHOOK: 
						 Log.e("MusicSearch DEBUG", "phone is off hook"); 
 						 mResumeAfterCall = isPlaying();
						 pause();
						 break;
						 
					case TelephonyManager.CALL_STATE_RINGING: 
						 Log.e("MusicSearch DEBUG", "phone is ringing"); 
						 mResumeAfterCall = isPlaying();
						 pause();
						 break;						 
		...
		tManager.listen(mPsir, PhoneStateListener.LISTEN_CALL_STATE); 			
    }

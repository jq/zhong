...
public class MusicPage extends Activity implements SeekBar.OnSeekBarChangeListener{
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ((TextView) findViewById(R.id.row_title)).setText(this.getString(R.string.title)+mMp3Title);
    ((TextView) findViewById(R.id.row_artist)).setText(this.getString(R.string.artist)+mMp3Songer);
    ...
    map1.put("ItemTitle", this.getString(R.string.search_more) + " " + this.mMp3Songer);
    ...
    map2.put("ItemTitle",  this.getString(R.string.search_more) +  " " + this.mMp3Title);
...
//                  mPlayStop.setImageResource(R.drawable.play);
            ...
            */
          //}else
          //  Toast.makeText(MusicPage.this, "Please select link in search results first", Toast.LENGTH_SHORT).show();
        //}else
        //  Toast.makeText(MusicPage.this, "Please search music first", Toast.LENGTH_SHORT).show();
  ...
  private class DownloadTask extends UserTask<String, Integer, Integer>{
    ...
    public void onPostExecute(Integer result) {
        ...
        if(result == 1){
            Toast.makeText(MusicPage.this, m_CurDownloadFile + " download finished", Toast.LENGTH_LONG).show();
